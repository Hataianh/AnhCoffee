var app = angular.module('myapp', []).constant('api', '/api/phanhois/');
...
function mycontrol($scope, $http, $filter, api) {
    ...
    $scope.numberOfPages = function() {
        return Math.ceil($scope.phanhois.length / $scope.pageSize);
    }
    $scope.getData = function() {

        return $filter('filter')($scope.phanhois, $scope.timkiem)
    }
