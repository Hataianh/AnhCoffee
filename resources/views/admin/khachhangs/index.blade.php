...
<div lang="en" ng-app="myapp" ng-controller="mycontrol" class="card">
    ...
    <p><button class="btn btn-success" ng-click="showModal(0)"> Thêm mới <i class="fa fa-plus"></i></button></p>
        ...
        <table class="table table-bordered table-stripper">
            ...
            <tr ng-repeat="kh in staffs|filter: timkiem | begin:currentPage*pageSize | limitTo:pageSize">
        ...
        <td>@{{kh.dia_chi}}</td>
        <td>@{{kh.note}}</td>
        <td><button class=" btn btn-primary" ng-click="showModal(kh.id)"> <i class="fa fa-pen"></i></button></td>
                <td><button class="btn btn-danger" ng-click="deleteClick(kh.id)"> <i class="fa fa-trash"></i></button></td>
            </tr>
        </table>
