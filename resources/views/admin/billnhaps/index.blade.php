...
<div lang="en" ng-app="myapp" ng-controller="mycontrol" class="card">
    ...
    <p><button class="btn btn-success" ng-click="showModal(0)"> Thêm mới <i class="fa fa-plus"></i></button></p>
        ...
        <table class="table table-bordered table-stripper">
            ...
            <tr ng-repeat="bn in staffs|filter: timkiem | begin:currentPage*pageSize | limitTo:pageSize">
        ...
        <td>@{{bn.thanh_toan}}</td>
        <td>@{{bn.note}}</td>
        <td><button class=" btn btn-primary" ng-click="showModal(bn.id)"> <i class="fa fa-pen"></i></button></td>
                <td><button class="btn btn-danger" ng-click="deleteClick(bn.id)"> <i class="fa fa-trash"></i></button></td>
            </tr>
        </table>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="form-group">
                                ...
                                <div><input type="number" ng-model="staff.id_ncc" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label for="">ID NV: </label>
                                <div><input type="number" ng-model="staff.id_nhanvien" class="form-control"></div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div><input type="text" ng-model="staff.tong_tien" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label for="">Thanh toán: </label>
                                <div><input type="text" ng-model="staff.thanh_toan" class="form-control"></div>
                            </div>
                            <div class="form-group">
