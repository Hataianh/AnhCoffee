...
<div lang="en" ng-app="myapp" ng-controller="mycontrol" class="card">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-stripper">
            ...
            <tr ng-repeat="ph in phanhois|filter: timkiem | begin:currentPage*pageSize | limitTo:pageSize">
                <td>@{{$index+1+(currentPage)*pageSize}}</td>
                <td>@{{ph.name}}</td>
                <td><img src=" /admin_layout/uploads/@{{ph.image}}" style="width: 50px"></td>
                <td>@{{ph.level}}</td>
                <td>@{{ph.note}}</td>
                <td><button class=" btn btn-primary" ng-click="showModal(ph.id)"> <i class="fa fa-pen"></i></button></td>
                <td><button class="btn btn-danger" ng-click="deleteClick(ph.id)"> <i class="fa fa-trash"></i></button></td>
            </tr>
        </table>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="form-group">
                                ...
                                <div><input type="text" ng-model="phanhoi.name" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label for="">Hình ảnh: </label>
                                <div>
                                    <input type="file" class="form-control" id="file-upload" ng-model="phanhoi.image">
                                </div>
                                </br>
                                <div style="width:100px;height:100px" id="image">
                                    <img src="/admin_layout/uploads/@{{phanhoi.image}}" alt="Ảnh" style="width:100px;height:100px"
                                        ng-model="phanhoi.image">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="">Level: </label>
                                <select ng-model="phanhoi.level" class="form-control">
