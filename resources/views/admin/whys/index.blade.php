...
<div lang="en" ng-app="myapp" ng-controller="mycontrol" class="card">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-stripper">
            ...
            <tr ng-repeat="why in staffs|filter: timkiem | begin:currentPage*pageSize | limitTo:pageSize">
                <td>@{{$index+1+(currentPage)*pageSize}}</td>
                <td>@{{why.title}}</td>
                <td><img src=" /admin_layout/uploads/@{{why.image}}" style="width: 50px"></td>
                <td>@{{why.text}}</td>
                <td><button class=" btn btn-primary" ng-click="showModal(why.id)"> <i class="fa fa-pen"></i></button></td>
                <td><button class="btn btn-danger" ng-click="deleteClick(why.id)"> <i class="fa fa-trash"></i></button></td>
            </tr>
        </table>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="form-group">
                                ...
                                <div><input type="text" ng-model="staff.title" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label for="">Hình ảnh: </label>
                                <div><input type="text" ng-model="staff.image" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label for="">Nội dung: </label>
                                <div><input type="text" ng-model="staff.text" class="form-control"></div>
                            </div>
                        </div>
                    </div>
