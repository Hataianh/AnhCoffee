...
<div lang="en" ng-app="myapp" ng-controller="mycontrol" class="card">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-stripper">
            ...
            <tr ng-repeat="kho in staffs|filter: timkiem | begin:currentPage*pageSize | limitTo:pageSize">
        <td>@{{$index+1+(currentPage)*pageSize}}</td>
        <td>@{{kho.id_sp}}</td>
        <td>@{{kho.sl}}</td>
        <td><button class=" btn btn-primary" ng-click="showModal(kho.id)"> <i class="fa fa-pen"></i></button></td>
                <td><button class="btn btn-danger" ng-click="deleteClick(kho.id)"> <i class="fa fa-trash"></i></button>
                </td>
            </tr>
        </table>
        <nav aria-label="Page navigation example">
  <ul class="pagination">
    <li class="page-item" ng-disabled="currentPage == 0" ng-click="currentPage=currentPage-1"><a class="page-link" href="#"><i class="fa fa-angle-left"></i></a></li>
    ...
    <li class="page-item" ng-disabled="currentPage >= getData().length/pageSize - 1"
            ng-click="currentPage=currentPage+1"><a class="page-link" href="#"><i class="fa fa-angle-right"></i></a></li>
  </ul>
</nav>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="form-group">
                                ...
                                <div><input type="number" ng-model="staff.id_sp" class="form-control"></div>
                            </div>
                        </div>
                        <div class="container-fluid">
                            <div class="form-group">
                                <label for="">Số lượng: </label>
                                <div><input type="number" ng-model="staff.sl" class="form-control"></div>
                            </div>
                        </div>
                    </div>
