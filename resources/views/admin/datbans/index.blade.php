...
<div lang="en" ng-app="myapp" ng-controller="mycontrol" class="card">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-stripper">
            ...
            <tr ng-repeat="db in datbans|filter: timkiem | begin:currentPage*pageSize | limitTo:pageSize">
        ...
        <td>@{{db.time}}</td>
        <td><button class=" btn btn-primary" ng-click="showModal(db.id)"> <i class="fa fa-pen"></i></button></td>
                <td><button class="btn btn-danger" ng-click="deleteClick(db.id)"> <i class="fa fa-trash"></i></button>
                </td>
            </tr>
        </table>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="form-group">
                                ...
                                <div><input type="text" ng-model="datban.name" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label for="">SDT: </label>
                                <div><input type="text" ng-model="datban.sdt" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label for="">Email: </label>
                                <div><input type="text" ng-model="datban.email" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label for="">Số người: </label>
                                <select ng-model="datban.sl" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div><input type="date" ng-model="datban.date" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label for="">Giờ: </label>
                                <div><input type="time" ng-model="datban.time" class="form-control"></div>
                            </div>
                        </div>
                    </div>
