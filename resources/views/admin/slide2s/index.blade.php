...
<div lang="en" ng-app="myapp" ng-controller="mycontrol" class="card">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-stripper">
            ...
            <tr ng-repeat="sl2 in slide2s|filter: timkiem | begin:currentPage*pageSize | limitTo:pageSize">
                <td>@{{$index+1+(currentPage)*pageSize}}</td>
                <td><img src="/admin_layout/uploads/@{{sl2.image}}" style="width: 50px"></td>
                <td><button class=" btn btn-primary" ng-click="showModal(sl2.id)"> <i class="fa fa-pen"></i></button></td>
                <td><button class="btn btn-danger" ng-click="deleteClick(sl2.id)"> <i class="fa fa-trash"></i></button></td>
            </tr>
        </table>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="file" class="form-control" id="file-upload" ng-model="slide2.image">
                                </div>
                                </br>
                                <div style="width:100px;height:100px" id="image">
                                    <img src="/admin_layout/uploads/@{{slide2.image}}" alt="Ảnh" style="width:100px;height:100px"
                                        ng-model="slide2.image">
                                </div>
                            </div>
