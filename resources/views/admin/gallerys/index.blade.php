...
<div lang="en" ng-app="myapp" ng-controller="mycontrol" class="card">
    ...
    <div class="card-body">
        ...
        <table class="table table-bordered table-stripper">
            ...
            <tr ng-repeat="gallery in gallerys|filter: timkiem | begin:currentPage*pageSize | limitTo:pageSize">
                <td>@{{$index+1+(currentPage)*pageSize}}</td>
                <td><img src="/admin_layout/uploads/@{{gallery.image}}" style="width: 50px"></td>
                <td><button class=" btn btn-primary" ng-click="showModal(gallery.id)"> <i class="fa fa-pen"></i></button></td>
                <td><button class="btn btn-danger" ng-click="deleteClick(gallery.id)"> <i class="fa fa-trash"></i></button></td>
            </tr>
        </table>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="form-group">
                                ...
                                <div>
                                    <input type="file" class="form-control" id="file-upload" ng-model="gallery.image">
                                </div>
                                </br>
                                <div style="width:100px;height:100px" id="image">
                                    <img src="/admin_layout/uploads/@{{gallery.image}}" alt="Ảnh" style="width:100px;height:100px"
                                        ng-model="gallery.image">
                                </div>
                            </div>
                        </div>
                    </div>
